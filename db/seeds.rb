...
venue = Venue.create!(id: "1", name: 'Bodega Negra', address: '16 Moor St, Soho, London W1D 5NH', area: 'Soho', category: ['Restaurant', 'Bar'], mood: 'fun', description: 'Mexican food in light upstairs cafe and hacienda-style cellar restaurant with lengthy tequila menu.', price: '£££', light_level: '3', noise_level: '7', couch_comfort: '4', staff_level: '6', unicorn_score: '8', distance_from_bed: '')
venue2 = Venue.create!(id: "2", name: 'Barts', address: 'Chelsea Cloisters, 87 Sloane Ave, Chelsea, London SW3 3DW', area: 'Chelsea', category: 'Bar', mood: 'seductive', description: 'Speakeasy cocktail bar with quirky wall ornaments and dressing-up boxes, plus vintage afternoon tea.', price: '££', light_level: '3', noise_level: '8', couch_comfort: '7', staff_level: '9', unicorn_score: '9', distance_from_bed: '')
venue3 = Venue.create!(id: "3", name: 'Evans & Peel Detective Agency', address: '310c Earls Ct Rd, Kensington, London SW5 9BA', area: 'Kensington', category: ['Restaurant', 'Bar'], mood: 'adventurous', description: 'Evans and Peel Detective Agency in London is a speakeasy bar and restaurant in Earls Court that serves up a 1920s prohibition drinking and eating experience.', price: '££', light_level: '5', noise_level: '3', couch_comfort: '5', staff_level: '8', unicorn_score: '10', distance_from_bed: '')
venue4 = Venue.create!(id: "4", name: 'Bar 212', address: '212 Brick Ln, London E1 6SA', area: 'Shoreditch', category: 'Bar', mood: 'chill', description: 'The 212 Café & Bar is a hangout for music, food and art lovers.', price: '££', light_level: '3', noise_level: '7', couch_comfort: '8', staff_level: '6', unicorn_score: '8', distance_from_bed: '')
venue5 = Venue.create!(id: "5", name: 'Daisy Green', address: '20 Seymour St, Marylebone, London W1H 7HX', area: 'Marylebone', category: ['Restaurant', 'Bar'], mood: 'chill', description: 'Artisan coffee, gourmet frozen yogurt and healthy bites in a quirky, vibrant cafe with grass carpet.', price: '££', light_level: '9', noise_level: '4', couch_comfort: '4', staff_level: '8', unicorn_score: '8', distance_from_bed: '')
...
# venue4 = Venue.create!(id: "4", name: 'Bar 212', address: '212 Brick Ln, London E1 6SA', area: 'Shoreditch', category: 'Bar', mood: 'chill', description: 'The 212 Café & Bar is a hangout for music, food and art lovers', price: '££', light_level: '3', noise_level: '7', couch_comfort: '8', staff_level: '6', unicorn_score: '8', distance_from_bed: '', photo: File.open(Rails.root.join('app/assets/images/bar212.png')))
# venue5 = Venue.create!(id: "5", name: 'Daisy Green', address: '20 Seymour St, Marylebone, London W1H 7HX', area: 'Marylebone', category: ['Restaurant', 'Bar'], mood: 'chill', description: 'Artisan coffee, gourmet frozen yogurt and healthy bites in a quirky, vibrant cafe with grass carpet.', price: '££', light_level: '9', noise_level: '4', couch_comfort: '4', staff_level: '8', unicorn_score: '8', distance_from_bed: '', photo: File.open(Rails.root.join('app/assets/images/daisygreen.png')))
